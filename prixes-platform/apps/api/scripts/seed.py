...
FALLBACK_PRODUCTS = [
    {"barcode": "3017760000011", "name": "Danone Yaourt Nature", "brand": "Danone", "categories": "Produits laitiers", "image_url": "https://via.placeholder.com/400x300?text=Yaourt"},
    {"barcode": "3274080005003", "name": "Labeyrie Saumon Fume", "brand": "Labeyrie", "categories": "Produits laitiers", "image_url": "https://via.placeholder.com/400x300?text=Saumon"},
    {"barcode": "3250391003054", "name": "Nestle Petit-Dej Cereales", "brand": "Nestle", "categories": "Petit-dejeuner", "image_url": "https://via.placeholder.com/400x300?text=Cereales"},
    {"barcode": "4001724006507", "name": "Kelloggs Cornflakes", "brand": "Kelloggs", "categories": "Petit-dejeuner", "image_url": "https://via.placeholder.com/400x300?text=Cornflakes"},
    {"barcode": "7613032749221", "name": "Lu Biscuit Chocolat", "brand": "Lu", "categories": "Biscuits & gateaux", "image_url": "https://via.placeholder.com/400x300?text=Biscuit"},
    {"barcode": "8710822009042", "name": "Oreo Cookies", "brand": "Oreo", "categories": "Biscuits & gateaux", "image_url": "https://via.placeholder.com/400x300?text=Cookies"},
    {"barcode": "5449000224413", "name": "Coca-Cola Zero", "brand": "Coca-Cola", "categories": "Boissons", "image_url": "https://via.placeholder.com/400x300?text=Coca"},
    {"barcode": "4001123456789", "name": "Tropicana Jus Orange", "brand": "Tropicana", "categories": "Boissons", "image_url": "https://via.placeholder.com/400x300?text=Jus"},
    {"barcode": "5410188016961", "name": "Barilla Pates Spaghetti", "brand": "Barilla", "categories": "Pates & riz", "image_url": "https://via.placeholder.com/400x300?text=Pates"},
    {"barcode": "3228857000277", "name": "Uncle Bens Riz Blanc", "brand": "Uncle Ben's", "categories": "Pates & riz", "image_url": "https://via.placeholder.com/400x300?text=Riz"},
    {"barcode": "737628064502", "name": "Lindor Truffes Chocolat", "brand": "Lindor", "categories": "Chocolats", "image_url": "https://via.placeholder.com/400x300?text=Lindor"},
    {"barcode": "42111422", "name": "Milka Tablette Chocolat", "brand": "Milka", "categories": "Chocolats", "image_url": "https://via.placeholder.com/400x300?text=Milka"},
]
...
def _jitter(barcode: str, store: str) -> float:
    ...
    h = hashlib.md5(f"{barcode}:{store}".encode()).hexdigest()
...
async def main(per_cat: int, n_deals: int) -> None:
    ...
    async with httpx.AsyncClient(headers={"User-Agent": "Prixes-Seeder/1.0"}) as client:
        async with SessionLocal() as db:
            ...
            if existing_deals == 0 and seeded:
                ...
                for product in picks:
                    ...
                    created_at_naive = created_at_aware.replace(tzinfo=None)  # Strip timezone for DB storage
                    deal = Deal(
                        author_id=demo.id,
    ...
    try:
        ...
        pass  # Redis close timed out, but script is exiting anyway
